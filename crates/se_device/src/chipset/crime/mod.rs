...
//! memory, CMI, and CGI domains. Link components retain transaction correlation;
//! the machine runtime owns functional routing and completion order.
...
use self::piu::{CrimePiu, CrimePiuState, PiuEffect};
use self::protocol::{
    ...
    CrimePoll, CrimeSdramSignal, CrimeSysAdCompletion, CrimeSysAdRequest, CrimeTransactionId,
